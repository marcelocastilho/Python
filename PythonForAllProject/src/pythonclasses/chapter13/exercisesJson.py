...
#Actual data: http://py4e-data.dr-chuck.net/comments_119191.json (Sum ends with 48)
...
url = 'http://py4e-data.dr-chuck.net/comments_119191.json'
print('Using the url:', url)

jsonFile = urllib.request.urlopen(url, context=ctx).read()
# print('Encoded UTF-8 data:', jsonFile)

jsonData = json.loads(jsonFile)
# print('Decoded unicode data', json.dumps(jsonData,indent=4))

print('Quantidade de usuarios:', len(jsonData['comments']))
